"""
turkiye_il_ilce.py — TÜRKİYE'NİN 81 İLİ VE TÜM İLÇELERİ
======================================================
Kaynak: TÜİK / İçişleri Bakanlığı güncel verileri.
Her il için tüm ilçeler, slug formatı ve tip bilgisi.
"""
...
TURKIYE_IL_ILCE = {
    ...
    "Adıyaman": [
        "Besni", "Çelikhan", "Gerger", "Gölbaşı", "Kâhta",
    ...
    "Afyonkarahisar": [
        ...
        "Sandıklı", "Sincanlı", "Sultandağı", "Şuhut",
    ],
    "Ağrı": [
    ...
    "Balıkesir": [
        ...
        "Bigadiç", "Burhaniye", "Dursunbey", "Edremit",
        "Erdek", "Gömeç", "Gönen", "Havran", "İvrindi",
        "Karesi", "Kepsut", "Manyas", "Marmara", "Savaştepe",
        "Sındırgı", "Susurluk",
    ],
    "Bartın": [
    ...
    "Bitlis": [
        "Adilcevaz", "Ahlat", "Güroymak", "Hizan", "Merkez",
        "Mutki", "Tatvan",
    ],
    "Bolu": [
    ...
    "Çanakkale": [
        ...
        "Çan", "Eceabat", "Ezine", "Gelibolu", "Gökçeada",
    ...
    "Çorum": [
        "Alaca", "Bayat", "Boğazkale", "Dodurga",
        "İskilip", "Kargı", "Laçin", "Mecitözü",
        "Merkez", "Oğuzlar", "Ortaköy", "Osmancık",
        "Sungurlu", "Uğurludağ",
    ],
    "Denizli": [
        "Acıpayam", "Babadağ", "Baklan", "Bekilli",
        "Beyağaç", "Bozkurt", "Buldan", "Çal", "Çameli",
        "Çardak", "Çivril", "Güney", "Honaz", "Kale",
        "Merkezefendi", "Pamukkale", "Sarayköy", "Serinhisar",
        "Tavas",
    ],
    "Diyarbakır": [
    ...
    "Elazığ": [
        "Ağın", "Alacakaya", "Arıcak", "Baskil",
        "Karakoçan", "Keban", "Kovancılar", "Maden",
        "Merkez", "Palu", "Sivrice",
    ],
    "Erzincan": [
    ...
    "Erzurum": [
        ...
        "Pazaryolu", "Şenkaya", "Tekman", "Tortum",
        "Uzundere", "Yakutiye",
    ],
    "Eskişehir": [
        "Alpu", "Beylikova", "Çifteler", "Günyüzü",
        "Han", "İnönü", "Mahmudiye", "Mihalgazi",
        "Mihalıççık", "Odunpazarı", "Sarıcakaya",
        "Seyitgazi", "Sivrihisar", "Tepebaşı",
    ],
    "Gaziantep": [
        "Araban", "İslahiye", "Karkamış", "Nizip",
        "Nurdağı", "Oğuzeli", "Şahinbey", "Şehitkamil",
        "Yavuzeli",
    ],
    "Giresun": [
        "Alucra", "Bulancak", "Çamoluk", "Çanakçı",
        "Dereli", "Doğankent", "Espiye", "Eynesil",
        "Görele", "Güce", "Keşap", "Merkez",
        "Piraziz", "Şebinkarahisar", "Tirebolu", "Yağlıdere",
    ],
    "Gümüşhane": [
        "Kelkit", "Köse", "Kürtün", "Merkez",
        "Şiran", "Torul",
    ],
    "Hakkâri": [
    ...
    "Hatay": [
        ...
        "Dörtyol", "Erzin", "Hassa", "İskenderun",
        "Kırıkhan", "Kumlu", "Payas", "Reyhanlı",
        "Samandağ", "Yayladağı",
    ],
    "Iğdır": [
    ...
    "Isparta": [
        ...
        "Gönen", "Keçiborlu", "Merkez", "Senirkent",
        "Sütçüler", "Şarkikaraağaç", "Uluborlu",
    ...
    "İzmir": [
        "Aliağa", "Balçova", "Bayındır", "Bayraklı",
        "Bergama", "Beydağ", "Bornova", "Buca", "Çeşme",
        "Çiğli", "Dikili", "Foça", "Gaziemir", "Güzelbahçe",
        "Karabağlar", "Karaburun", "Karşıyaka", "Kemalpaşa",
        "Kınık", "Kiraz", "Konak", "Menderes", "Menemen",
        "Narlıdere", "Ödemiş", "Seferihisar", "Selçuk",
        "Tire", "Torbalı", "Urla",
    ],
    "Kahramanmaraş": [
    ...
    "Kastamonu": [
        ...
        "Küre", "Merkez", "Pınarbaşı", "Seydiler",
    ...
    "Kocaeli": [
        "Başiskele", "Çayırova", "Darıca", "Dilovası",
        "Gebze", "Gölcük", "İzmit", "Kandıra",
    ...
    "Kütahya": [
        ...
        "Merkez", "Pazarlar", "Şaphane", "Simav", "Tavşanlı",
    ],
    "Malatya": [
        "Akçadağ", "Arapgir", "Arguvan", "Battalgazi",
        "Darende", "Doğanşehir", "Doğanyol", "Hekimhan",
        "Kale", "Kuluncak", "Pütürge", "Yazıhan", "Yeşilyurt",
    ],
    "Manisa": [
        "Ahmetli", "Akhisar", "Alaşehir", "Demirci",
        "Gölmarmara", "Gördes", "Kırkağaç", "Köprübaşı",
        "Kula", "Salihli", "Sarıgöl", "Saruhanlı",
        "Şehzadeler", "Selendi", "Soma", "Turgutlu",
        "Yunusemre",
    ],
    "Mardin": [
        "Artuklu", "Dargeçit", "Derik", "Kızıltepe",
        "Mazıdağı", "Midyat", "Nusaybin", "Ömerli",
        "Savur", "Yeşilli",
    ],
    "Mersin": [
        "Akdeniz", "Anamur", "Aydıncık", "Bozyazı",
        "Çamlıyayla", "Erdemli", "Gülnar", "Mezitli",
        "Mut", "Silifke", "Tarsus", "Toroslar", "Yenişehir",
    ],
    "Muğla": [
        "Bodrum", "Dalaman", "Datça", "Fethiye",
        "Kavaklıdere", "Köyceğiz", "Marmaris", "Menteşe",
    ...
    "Ordu": [
        "Akkuş", "Altınordu", "Aybastı", "Çamaş",
        "Çatalpınar", "Çaybaşı", "Fatsa", "Gölköy",
        "Gülyalı", "Gürgentepe", "İkizce", "Kabadüz",
    ...
    "Sakarya": [
        ...
        "Karasu", "Kaynarca", "Kocaali", "Pamukova",
        "Sapanca", "Serdivan", "Söğütlü", "Taraklı",
    ],
    "Samsun": [
        "19 Mayıs", "Alaçam", "Asarcık", "Atakum",
        "Ayvacık", "Bafra", "Canik", "Çarşamba",
        "Havza", "İlkadım", "Kavak", "Ladik",
    ...
    "Sinop": [
        ...
        "Erfelek", "Gerze", "Merkez", "Saraydüzü",
        "Türkeli",
    ],
    "Şırnak": [
    ...
    "Sivas": [
        ...
        "Gemerek", "Gölova", "Gürün", "Hafik",
        "İmranlı", "Kangal", "Koyulhisar", "Merkez",
        "Suşehri", "Şarkışla", "Ulaş", "Yıldızeli",
        "Zara",
    ],
    "Tekirdağ": [
        "Çerkezköy", "Çorlu", "Ergene", "Hayrabolu",
        "Kapaklı", "Malkara", "Marmara Ereğlisi",
    ...
    "Trabzon": [
        ...
        "Çarşıbaşı", "Çaykara", "Dernekpazarı", "Düzköy",
        "Hayrat", "Köprübaşı", "Maçka", "Of",
        "Ortahisar", "Sürmene", "Şalpazarı", "Tonya",
        "Vakfıkebir", "Yomra",
    ],
    "Tunceli": [
    ...
    "Van": [
        "Bahçesaray", "Başkale", "Çaldıran", "Çatak",
        "Edremit", "Erciş", "Gevaş", "Gürpınar",
    ...
    "Yozgat": [
        ...
        "Saraykent", "Sarıkaya", "Şefaatli", "Sorgun",
        "Yenifakılı", "Yerköy",
    ],
    "Zonguldak": [
        "Alaplı", "Çaycuma", "Devrek", "Ereğli",
        "Gökçebey", "Kilimli", "Kozlu", "Merkez",
    ],
}
...
def IL_ADI(slug):
    for il in TURKIYE_IL_ILCE:
        if slugify_tr(il) == slug:
            return il
    return slug.replace("-", " ").title()

def ILCE_ADI(il_slug, ilce_slug):
    il = IL_ADI(il_slug)
    if il in TURKIYE_IL_ILCE:
        for ilce in TURKIYE_IL_ILCE[il]:
            if slugify_tr(ilce) == ilce_slug:
                return ilce
    return ilce_slug.replace("-", " ").title()

def get_cities():
    return list(TURKIYE_IL_ILCE.keys())

def get_districts(city_name):
    return TURKIYE_IL_ILCE.get(city_name, [])

IL_LIST = [
    {"name": name, "slug": slugify_tr(name), "type": "city"}
    for name in TURKIYE_IL_ILCE
]

ILCE_LIST = [
    {
        "name": ilce,
        "slug": slugify_tr(ilce),
        "type": "district",
        "parent": slugify_tr(il),
        "parent_name": il,
    }
    for il, ilceler in TURKIYE_IL_ILCE.items()
    for ilce in ilceler
]

ALL_LOCATIONS = IL_LIST + ILCE_LIST
